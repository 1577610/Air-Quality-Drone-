	...
	\begin{center}
		\resizebox{\columnwidth}{!}{%
			\begin{tabular}{|c|c|c|c|c|c|c|c|}
				\hline
				  & \acs{NO2} & PM10 Jahresmittel & PM10 Überschreitungen des Tagesmittels & Ozon # Tage mit 8-stündlichem Mittel > 120 $^\mu g$/m\textsuperscript{3} & \acs{SO2} & Benzol & Gesamtindex\\ \hline \hline
...
\section{Sensoren Luftqualität}\label{sec:Sensoren Luftqualität}
