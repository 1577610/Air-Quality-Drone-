...
%% des Dokuments.
\setzemartrikelnr{8870320}
\setzekurs{STG-TINF15-ITA}
\setzetitel{Entwurf und Umsetzung eines Messsystems zur Luftqualitätsmessung mittels einer Drohne}
...
\setzezeitraum{04.11.2017 - 04.06.2018}
\setzearbeit{Studienarbeit}
\setzeautor{Sebastian Breit}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
