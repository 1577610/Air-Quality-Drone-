...
%% des Dokuments.
\setzemartrikelnr{1577610, 8870320}
\setzekurs{STG-TINF15ITA}
\setzetitel{Air Quality Drone}
%\setzetitel{Logfileanalyse mit Apache{\textsuperscript{TM}} Hadoop\textsuperscript{{\textregistered}} MapReduce}
\setzedatumAbgabe{17.11.2017}
...
\setzedhbw{Stuttgart}
\setzebetreuer{Rene Lasse, Thilo Ackermann}
\setzegutachter{nothing}
\setzezeitraum{04.11.2017 - 17.11.2017}
\setzearbeit{Pflichtenheft Studienarbeit}
\setzeautor{Julian Riegger, Sebastian Breit}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
